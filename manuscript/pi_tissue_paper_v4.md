...
CR does not restore aged V_tissue toward young levels; it reduces aged V_residual. Mechanistically, this distinguishes CR from interventions that would act on the structural component — for example, Yamanaka-factor-based partial epigenetic reprogramming, which targets chromatin state directly. The variance-decomposition framework separates these two mechanistic classes in any transcriptomic dataset where young, old, and treated samples are available together, and this partition is not obvious from bulk transcriptomic measures other than variance decomposition. We note it as the main practical consequence of the framework for intervention biology.
...
Andrei V. Gudkov (Roswell Park Comprehensive Cancer Center) provided scientific input on the biological framing, the dividing-vs-non-dividing architectural hypothesis, the positioning of this work in the systemic-noise versus selective-accumulation debate, and the scope of the cross-species comparison. Katerina Andrianova (Vaika, Inc.) provided administrative support. All analyses were performed by the author.
